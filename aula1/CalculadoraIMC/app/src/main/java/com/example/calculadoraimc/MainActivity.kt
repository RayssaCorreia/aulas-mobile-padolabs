...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calcular.setOnClickListener {
            ...
            val imc = (Peso/(Altura*Altura)).toInt()

            if(Idade <=24){
                if (imc < 19 ){
                    resultado.setText("IMC =" + imc +"Peso Baixo")
                } else if (imc >= 19 && imc <= 24.9){
                    resultado.setText("IMC =" + imc + "Peso normal")
                } else if(imc >= 25 && imc <= 29.9){
                    resultado.setText("IMC =" + imc + "Pré obesidade")
                } else if(imc >= 30 && imc <= 34.9){
                    resultado.setText("IMC =" + imc + "Obesidade")
                } else if(imc >= 35 && imc <= 39.9) {
                    resultado.setText("IMC =" + imc + "Obesidade grave")
                }
